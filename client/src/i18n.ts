    ...
    en: {
        translation: {
            ...
            "profile": {
                ...
                "file_too_large": "File is too large (max 5 MB). Please choose a smaller image.",
                "file_unsupported": "Unsupported format. Please use JPEG, PNG, WebP, or GIF. iPhone users: please convert HEIC photos first.",
            ...
            "auth": {
                ...
                "token_placeholder": "6-digit code from server logs",
    ...
    uk: {
        translation: {
            ...
            "profile": {
                ...
                "file_too_large": "Файл завеликий (макс. 5 МБ). Виберіть менше зображення.",
                "file_unsupported": "Непідтримуваний формат. Використовуйте JPEG, PNG, WebP або GIF. Користувачі iPhone: спочатку конвертуйте фото з HEIC.",
            ...
            "comments": {
                ...
                "unban": "Розбан",
                "ban_modal_title": "Забанити користувача",
            ...
            "auth": {
                ...
                "token_placeholder": "6-значний код з логів сервера",

    ...
    return (
        <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-4">
            <form onSubmit={handleSubmit} className="bg-slate-900 p-8 rounded-xl border border-slate-800 w-full max-w-sm">
                <h2 className="text-2xl font-bold text-emerald-400 mb-6 text-center">{t('auth.new_password_title')}</h2>

                <input
                    type="email" placeholder={t('auth.email_placeholder')} required
